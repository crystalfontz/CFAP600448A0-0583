...
//
// This project is for the CFAP600448A0-0583 :
//
//   https://www.crystalfontz.com/product/cfap600448a00583
//
...
void show_BMPs_in_root(void)
{
  ...
  while (1)
  {
    ...
    if (0 == bmp_file.isDirectory())
    {
      ...
      {
        Serial.println("file name includes bmp");
        ...
        if ( 360054 <= size)
        {
          ...
          static uint8_t quarter_line[150 * 3];
          for (int line = 0; line < 448*4; line++)
          {
            ...
            bmp_file.read(quarter_line, 150 * 3);

            //send the line to the display
            send_pixels_BW(150 * 3, quarter_line);
